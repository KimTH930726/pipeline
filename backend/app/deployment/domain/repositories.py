...
class DeploymentRepositoryPort(ABC):
    ...
    @abstractmethod
    async def count(self, branch: str | None = None, status: str | None = None, date_from: str | None = None, date_to: str | None = None) -> int: ...

    @abstractmethod
    async def find_recent(self, branch: str | None = None, status: str | None = None, date_from: str | None = None, date_to: str | None = None, limit: int = 10, offset: int = 0) -> list[Deployment]: ...
